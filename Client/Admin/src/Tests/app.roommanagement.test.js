...
describe('admin', () => {
  ...
  it('admin', async () => {
    ...
    const adminElement = await driver.wait(
      until.elementLocated(By.css('li:nth-child(2) .align-middle')),
      10000
    );
    ...
    const secondaryElement = await driver.wait(
      until.elementLocated(By.css('tr:nth-child(6) a > .align-middle')),
      10000
    );
    ...
    await personsElement.click();
    await personsElement.sendKeys('1');
    await driver.findElement(By.id("facilities")).click()
    await driver.findElement(By.id("facilities")).sendKeys("AC -free wifi,pool access")
